...
class MoveText(text.Label):
    ...
    def __init__(self, text='', font_name=None, font_size=None, bold=False, italic=False, color=None, x=0, y=0, width=5, height=None, anchor_x='left', anchor_y='top', align='left', multiline=True, dpi=None, batch=None, group=None):
